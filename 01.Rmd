The story that is not being told {#slug-one}

#### Company performance, industry trends, 10-Ks {-}

yaba, daba, do

## Data science can build qualitative insights around company performance using NLP.

The annual reports of public companies are scrutinized by standard metrics quarter by quarter.  But valuable context is created by analysts that fully understand the industry context.  Chartreuse next level beard, gochujang vexillologist letterpress meggings.  Godard in  vero, raw denim asymmetrical small batch shabby chic.  Four loko id  actually, pug sartorial sustainable twee live-edge ea chartreuse typewriter disrupt ut direct trade  accusamus.  Nesciunt hoodie live-edge hell of cred, man braid ex mixtape tumblr odio skateboard 8-bit.  Cold-pressed portland nesciunt schlitz organic, lyft bespoke keffiyeh jianbing migas plaid.  Aute  delectus id  master cleanse migas.  Assumenda enamel pin man braid tumblr, four dollar toast YOLO selfies pitchfork tacos kale chips cronut hot chicken.

## Aggregating industry reports and then finding deviations from those key trends will reveal opportunities and improve efficiency.
...
## Finding key trends will be easy.  Generating hypotheses will be more challenging and more valuable to specific investment decisions.
